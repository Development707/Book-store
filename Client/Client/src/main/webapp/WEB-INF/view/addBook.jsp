<%-- 
    Document   : addBook
    Created on : 28 May 2021, 14:29:01
    Author     : longt
--%>
        ...
        <footer class="tm-footer row tm-mt-small">
            <div class="col-12 font-weight-light">
                <p class="text-center text-white mb-0 px-4 small">
                    Copyright &copy; 2021 | Thiết Kế Bởi <a rel="sponsored" href="https://www.facebook.com/thao.hoangthien.94" target="_blank" style="color: #fff">Hoàng Thiên Thảo  </a>
                </p>
            </div>
        </footer>
    </body>
