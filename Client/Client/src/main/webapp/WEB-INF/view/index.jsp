                        ...
                        <div class="row p-5">
                            ...
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left">
                                    <h1 class="h1 text-success"><b>Trương Nhật Long</b></h1>
                                    <h3 class="h2">MSSV: 18036331</h3>
                                    <p>
                                        Thực hiện code <b>Back-End</b>: tại API code Server xử lý sự kiện, thiết kế DataBase, tạo dữ liệu...
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="carousel-item">
                    <div class="container">
                        <div class="row p-5">
                            ...
                            <div class="col-lg-6 mb-0 d-flex align-items-center">
                                <div class="text-align-left">
                                    <h1 class="h1 text-success"><b>Hoàng Thiên Thảo</b></h1>
                                    <h3 class="h2">MSSV: 18018331</h3>
                                    <p>
                                        Thực hiện code <b>Font-End</b>: thiết kế tạo web, tạo dữ liệu cho DataBase, kiểm tra lỗi....
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 p-5 mt-3">
                    ...
                    <h5 class="text-center mt-3 mb-3">Đắng Nhân Tâm</h5>
                    ...
                    <div class="row pt-2">
                        <div class="col-12">
                            <p class="text-left text-light">
                                Copyright &copy; 2021 | Thiết Kế Bởi <a rel="sponsored" href="https://www.facebook.com/thao.hoangthien.94" target="_blank">Hoàng Thiên Thảo  </a>
                            </p>
                        </div>
                    </div>
                </div>
